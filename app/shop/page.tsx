...
export default function ShopPage() {
  ...
  const products: Product[] = [
    {
      id: 1,
      name: "Premium Burgundy & Cream Striped Aso-Oke Fabric Set",
      price: 20000,
      product_url: "/chocolate.jpg",
      description: "A set of perfect blend of patterned and plain textures, allowing for versatile styling",
      stock_quantity: 10,
      is_active: true,
    },
    {
      id: 2,
      name: "Elegant handwoven Jawu aso-oke fabric set",
      price: 20000,
      product_url: "/jawu.jpg",
      description: "Elegant handwoven aso-oke of brown and white stripe design",
      stock_quantity: 5,
      is_active: true,
    },
    {
      id: 3,
      name: "Premium aso-oke in rich burgundy with blue, black, and white stripe",
      price: 20000,
    ...
    {
      id: 3,
      name: "Olive Green Striped Aso-Oke Fabric Set",
      price: 20000,
    ...
    {
      id: 3,
      name: "Handwoven aso-oke in navy and sky blue tones with subtle burgundy stripe",
      price: 20000,
  ...
  return (
    <div>
                    ...
                    >
                      ...
                      <div className="p-4">
                        ...
                        <div className="flex justify-between mt-4">
                          <button
                            onClick={() => openProduct(product)}
                            className="text-xs bg-black cursor-pointer text-white px-4 py-2 rounded-full hover:scale-105 transition"
                          >
                            View
                          </button>
                          ...
                          <button
                            onClick={() => handleAddToCart(product, 1)}
                            disabled={isOutOfStock(product)}
                            className="text-xs border border-black cursor-pointer text-black px-4 py-2 rounded-full hover:bg-black hover:text-white transition disabled:opacity-40"
                          >
                            Add
                          </button>
                        </div>
      ...
      {selectedProduct && (
        <div
          className="fixed inset-0 z-50 flex items-center justify-center bg-[#1a1208]/60 backdrop-blur-sm p-4"
          onClick={closeProduct}
        >
          <div
            className="relative w-full max-w-3xl overflow-hidden rounded-2xl bg-[#fbf6ee] shadow-2xl"
            onClick={(e) => e.stopPropagation()}
          >
            <button
              onClick={closeProduct}
              className="absolute top-4 right-4 z-10 h-9 w-9 rounded-full bg-white shadow"
            >
              ✕
            </button>
            ...
            <div className="grid md:grid-cols-2">
              ...
              <div className="p-7">
                ...
                <button
                  ...
                  className="mt-6 w-full bg-black cursor-pointer text-white py-3 rounded-full"
                >
                  Add to Cart
                </button>
              </div>
